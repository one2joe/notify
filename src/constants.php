...
// Product version
define(PROJECT_NAMESPACE . "PRODUCT_VERSION", "18.12.4");

// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "project8"); // Project name
define(PROJECT_NAMESPACE . "PROJECT_ID", "{1FF20913-6D93-4C3A-AC1B-ED30581C38D2}"); // Project ID
